      ...
      <TracksContainer>
        ...
        <Row>
          ...
          <Column grow={1}>
            <TrackContainer>
              <Track
                description="How can we minimise the impact of increased living comfort on climate change by intelligently regulating all components?"
                imageURL="images/tracks/climate-intelligent-house.jpg"
                sponsor="Wolf"
                title="The climate intelligent house"
              />
            </TrackContainer>
          </Column>
        </Row>
