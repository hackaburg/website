...
<BaseComponent headline={'Schedule'} subHeadline={'When and what?'} id={'schedule'}>
	<Timetable>
		<Day date="Thu, 25.5.2023">
			<Spacer hours={8} minutes={0} />
			<Event hours={0} minutes={45} time="15:30 - 16:15" title="Registration" food />
			<Event hours={1} minutes={45} time="16:15 - 18:00" title="Opening Ceremony">
				<Event hours={0} minutes={20} time="17:00 - 17:20" title="Track Presentation" special />
				<Event
					hours={0}
					minutes={20}
					time="17:20 - 17:40"
					...
					special
				/>
				<Event hours={0} minutes={25} time="17:40 - 18:00" title="Idea Pitches" special />
			</Event>
			<Event hours={1} minutes={0} time="18:00 - 19:00" title="Dinner + Find your team" food />
		...
		<Day date="Sat, 27.5.2023">
			<Event hours={4} minutes={30} time="00:00 - 12:30" title="Hacking">
				...
				<Event hours={1} minutes={0} time="11:30 - 12:30" title="Project Registration" special>
					Register your project by 11:30, final submission by 12:30.
				</Event>
			</Event>
