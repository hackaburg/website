...
<BaseComponent
	...
	subHeadline={'We are Ratisbona Coding - we make Hackaburg'}
	id={'behind'}
>
<div class="w-full max-w-3xl mx-auto">
	<div class="text-center mb-24 text-white justify-center">
		<p>
			...
			2018 from the student organization team of the Hackaburg Hackathon. As a young association, we
			organize other IT events in the Regensburg region in addition to Hackaburg.
		</p>
    <div>
			<a href="https://ratisbona-coding.org/" target="_blank">
				<div class="relative group">
          {#if glowVisible}
            <div class="absolute w-52 h-10 mt-4 transform -translate-x-1/2 -translate-y-1/2 border top-1/2 left-1/2 -inset-0.5 round-2xl bg-gradient-to-r from-primary to-primary rounded-lg blur opacity-75 group-hover:opacity-100" />
          {/if}
