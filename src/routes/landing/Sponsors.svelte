...
>
	<div class="text-center dark:text-white">
		...
		<a href="mailto:sponsor@ratisbona-coding.org">
			<button
				class="m-auto w-52 mt-8 border-2 border-white rounded-3xl px-3 py-2 dark:text-white hover:cursor-pointer hover:bg-black hover:text-gray-200"
			>
				Please contact us
			</button>
		</a>
		<h2 class="text-xl font-bold text-center text-black-800 mt-12">
			Supporters that trusted us over the years
		</h2>
